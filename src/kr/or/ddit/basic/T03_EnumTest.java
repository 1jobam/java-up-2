...
public class T03_EnumTest {
	...
	public enum Season{
		...
		//생성자 만들기(열거형의 생성자가 묵시적으로 'private'이다.)
	 ...
	 */
		...
		System.out.println("ordinal => " + sa.ordinal());
		System.out.println("get메서드 => " + sa.getStr());
		System.out.println("------------------------------------");
		// 열거이름.values() => 데이터를 배열로 가져온다.
